...
//первый параметр ширина включения блока, второй ширина меню, если ширина меню должна быть на весь экран поставить '100%'
//flsFunctions.menuRight(750, 320);
flsFunctions.menuLeft(1023, true);
